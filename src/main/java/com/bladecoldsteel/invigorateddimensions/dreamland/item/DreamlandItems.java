...
import com.bladecoldsteel.invigorateddimensions.dreamland.item.custom.PocketWatchItem;
...
public class DreamlandItems {
    ...
    public static final RegistryObject<PocketWatchItem> POCKET_WATCH = ITEMS.register("pocket_watch",
