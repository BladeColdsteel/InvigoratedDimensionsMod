...
public class CrystallizedLeavesBlock extends LeavesBlock {
    ...
    private ItemStack saplingPerBiome(ResourceLocation biomeKey) {
        if (isElectricBiome(biomeKey)) {
            ...
            return new ItemStack(WateryDepthsBlocks.SAPLING.get());
            ...
            return new ItemStack(TerraNataBlocks.SAPLING.get());
            ...
            return new ItemStack(ValleyDeathBlocks.SAPLING.get());
    ...
    private ItemStack randomSapling() {
        ItemStack[] saplings = {
                ...
                new ItemStack(WateryDepthsBlocks.SAPLING.get()),
                ...
                new ItemStack(ValleyDeathBlocks.SAPLING.get()),
                new ItemStack(FeywildExpanseBlocks.SAPLING.get()),
                new ItemStack(TerraNataBlocks.SAPLING.get()),
